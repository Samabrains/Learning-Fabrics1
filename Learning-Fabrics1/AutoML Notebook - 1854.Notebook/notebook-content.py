...
import pandas as pd
# Load data into pandas DataFrame from "/lakehouse/default/Tables/Group_Active_Loans csv_predictions/part-00004-ed5130c9-d6d4-4074-9df4-96e846dd2897-c000.snappy.parquet"
df = pd.read_parquet("/lakehouse/default/Tables/Group_Active_Loans csv_predictions/part-00004-ed5130c9-d6d4-4074-9df4-96e846dd2897-c000.snappy.parquet")
display(df)
...
target_col = re.sub('[^A-Za-z0-9_]+', '_', "OSP")
...
mlflow.set_experiment("MLMODEL-AutoMLExperiment")
...
settings = {
    ...
    "force_cancel": True, 
    "seed": 41 , # Random seed 
    "mlflow_exp_name": "MLMODEL-AutoMLExperiment",  # MLflow experiment name
...
with mlflow.start_run(nested=True, run_name="MLMODEL"):
    automl.fit(
        X_train=X_train, 
...
registered_model = mlflow.register_model(model_uri=model_path, name="MLMODEL")
...
saved_name = "Tables/Group_Active_Loans csv_predictions".replace(".", "_")
